---
title: "LaTeX 使用小结"
date: 2013-03-07T19:53:36.000+08:00
revised: 2026-07-29T08:41:02.755+08:00
draft: false
---

1.IEEEtrans

前段时间因为忍受不了用 word/mathtype 输入公式了，所以就先学现用用 LaTeX 写了一份报告。在看教程的时候看到了有 `IEEEtrans` 这样的文档格式，自己常常被 IEEE 的论文虐，而正好报告写的东西也是和 CS 相关的，所以就学了一下 `IEEEtrans` 的用法。
